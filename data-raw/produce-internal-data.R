...
# ==============================================================================
# VI. T13-1 summer/winter layer trackings (CP2016 Fig.02b)
# ==============================================================================

rlang::check_installed("tibble", version = "3.2.1")

# depth indices of summer and winter layers, determined and hard-coded during
# CP16 paper preparation
s1 <- c(3, 3, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 3, 3, 4, 4, 4, 4, 3, 4, 3, 3, 4, 4,
        4, 3, 3, 3, 3, 2, 1, 1, 2, 1, 2, 1, 3, 3)

s2 <- c(10, 10, 10, 10, 10, 10, 10, 11, 11, 10, 10, 10, 10, 10, 11, 11, 11, 11,
        12, 12, 12, 11, 11, 11, 11, 12, 11, 11, 11, 10, 10, 11, 10, 11, 11, 11,
        12, 12)

s3  <- c(17, 18, 17, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 18, 18, 19, 19, 17,
         17, 20, 18, 19, 18, 19, 19, 20, 19, 19, 20, 19, 19, 20, 20, 20, 20, 20,
         20, 20)

s4 <- c(NA, 27, 26, 26, 26, 26, 26, 26, 27, 25, 25, 27, 27, 24, 27, 27, 30, 29,
        28, 28, 27, 28, 28, 30, 25, 25, 24, 24, 23, 22, 28, 29, 25, 25, 24, 28,
        25, 25)

s5 <- c(NA, 33, 31, 32, 32, 33, 32, 33, 33, 32, 33, 32, 33, 32, 33, 33, 33, 33,
        33, 34, 33, 33, 32, 34, 33, 33, 33, 32, 32, 32, 32, 32, 32, 33, 33, 33,
        33, 32)

w1 <- c(5, 4, 3, 5, 4, 4, 4, 4, 4, 6, 7, 7, 7, 7, 7, 8, 8, 6, 7, 7, 6, 8, 8, 7,
        8, 8, 5, 8, 8, 5, 7, 3, 5, 4, 5, 3, 5, 7)

w2 <- c(14, 14, 14, 14, 14, 14, 14, 13, 13, 14, 12, 12, 14, 15, 14, 14, 14, 14,
        15, 15, 15, 15, 15, 15, 15, 16, 15, 15, 15, 15, 14, 14, 13, 15, 15, 17,
        15, 15)

w3 <- c(NA, 21, 21, 21, 21, 22, 22, 21, 21, 20, 21, 22, 22, 22, 21, 22, 24, 22,
        22, 24, 23, 23, 26, 26, 22, 23, 22, 21, 21, 21, 24, 23, 23, 22, 22, 23,
        23, 22)

w4 <- c(NA, 32, 29, 31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 30, 29, 32, 30,
        31, 31, 31, 30, 30, 31, 27, 27, 27, 26, 26, 26, 30, 30, 27, 28, 28, 30,
        31, 28)

w5 <- c(NA, 36, 36, 36, 36, 36, 36, 37, 37, 37, 37, 36, 37, 37, 38, 38, 36, 37,
        38, 37, 37, 36, 36, 38, 38, 38, 38, 37, 36, 37, 36, 36, 36, 36, 36, 36,
        37, 36)

n <- unique(t13.trench1$profileName)
x <- getSurfaceProfile(t13.trench1)$position
z <- getZ(t13.trench1)
t13.layer.depth <-
  tibble::tibble(profileName = n, profilePosition = x,
                 s1 = z[s1], s2 = z[s2], s3 = z[s3], s4 = z[s4], s5 = z[s5],
                 w1 = z[w1], w2 = z[w2], w3 = z[w3], w4 = z[w4], w5 = z[w5])
