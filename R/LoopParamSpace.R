...
##' \donttest{
##' TR <- TrenchR:::makeHiResKohnenTrenches()
##' ParamSpace <- LoopParamSpace(rec.in = TR$mean13_HiRes$d18O,
##'                              reference = TR$mean15_HiRes$d18O,
##'                              res = 0.5, depth = TR$mean15_HiRes$depth,
